using TransportApex.Application.Common.Models;
using TransportApex.Application.TodoItems.Commands.CreateTodoItem;
using TransportApex.Application.TodoItems.Commands.DeleteTodoItem;
using TransportApex.Application.TodoItems.Commands.UpdateTodoItem;
using TransportApex.Application.TodoItems.Commands.UpdateTodoItemDetail;
using TransportApex.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;
using TransportApex.WebApi.Extensions;

namespace TransportApex.WebApi.Endpoints;
