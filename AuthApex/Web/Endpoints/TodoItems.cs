using DominiumEntregas.Application.Common.Models;
using DominiumEntregas.Application.TodoItems.Commands.CreateTodoItem;
using DominiumEntregas.Application.TodoItems.Commands.DeleteTodoItem;
using DominiumEntregas.Application.TodoItems.Commands.UpdateTodoItem;
using DominiumEntregas.Application.TodoItems.Commands.UpdateTodoItemDetail;
using DominiumEntregas.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace DominiumEntregas.Web.Endpoints;
...
public class TodoItems : EndpointGroupBase
{
    ...
    public static async Task<Ok<PaginatedList<TodoItemBriefDto>>> GetTodoItemsWithPagination(ISender sender, [AsParameters] GetTodoItemsWithPaginationQuery query)
    {
